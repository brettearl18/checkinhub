...
export default function CoachNewExercisePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setError(null);
    try {
      const res = await fetchWithAuth("/api/coach/exercises", {
        method: "POST",
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 className="mt-1 text-2xl font-semibold text-[var(--color-text)]">Add exercise</h1>
        <p className="mt-1 text-sm text-[var(--color-text-secondary)]">
          Add an exercise to your library. You can use it when building programs.
        </p>
      </div>
