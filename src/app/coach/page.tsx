    ...
    <div className="space-y-8">
      <header>
        ...
        <p className="mt-1 text-sm text-[var(--color-text-secondary)]">
          Your clients and their check-ins. Open a client to view history, add feedback, or assign a check-in.
        </p>
      </header>
      ...
      {!loading && clients.length > 0 && (
        <div className="space-y-4">
          ...
          <div className="grid gap-4 sm:grid-cols-1">
            {clients.map((c) => (
              <Card key={c.id} className="p-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
