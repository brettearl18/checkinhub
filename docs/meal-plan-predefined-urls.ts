/**
 * Predefined meal plan options (name + URL).
 * Copy this file into your new project, e.g. lib/meal-plan-predefined-urls.ts or constants/meal-plans.ts
 */

export const PREDEFINED_MEAL_PLANS: { name: string; url: string }[] = [
